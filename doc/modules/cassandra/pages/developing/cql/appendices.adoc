...
only have a specific meaning in certain context but can be used as
identifier otherwise. The reason for non-reserved
keywords is flexibility: keywords are non-reserved when it's
easy for the parser to decide whether they were used as keywords
or not.
